...
const Showcase = () => {
  const isTablet = useMediaQuery({ query: "all(max-width:1024px)" });
    ...
    <section id="showcase">
      ...
      <div className="content">
        <div className="wrapper">
            ...
            <div className="space-y-5 mt-7 pe-10">
              <p>
                ...
                <span className="text-white">
                  M4, the next genertaion of Apple silicon
                </span>
                . M4 powers
              </p>
              <p>
          ...
          <div className="max-w-3xs space-y-24">
            <div className="space-y-2">
              <p>Up to</p>
              <h3>4x faster</h3>
              <p>pro rendenring performance then M2</p>
            </div>
